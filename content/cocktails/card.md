...
home:
  eyebrow:
    ...
    en: The bar
  title:
    da: Cocktails skænket med samme omhu som køkkenet
    en: Cocktails poured with the same care as the kitchen
  description:
    da: Signatur- og klassiske cocktails bygget på sæson, håndværk og balance i smagen — fra lette, mousserende aperitifs til spiritusdrevne kompositioner.
    en: Signature and classic cocktails built on season, craft and balance — from light, sparkling aperitifs to spirit-forward compositions.

sections:
  - id: aperitif-court
    label:
      da: Aperitif-hoffet
      en: The Aperitif Court
    note:
      da: Et udvalg af lette, mousserende og diskret bitre cocktails, der åbner oplevelsen med friskhed, elegance og tilbageholdenhed. Bygget på vinbaserede kompositioner, fine frugtnoter og en let bitterhed.
      en: A selection of light, sparkling and gently bitter cocktails designed to open the experience with freshness, elegance and restraint. Built around wine-based compositions, delicate fruit notes and subtle bitterness.
    cocktails:
      - name: Kir Royale
        ingredients:
          da: Scavi & Ray Prosecco DOC, crème de cassis
          en: Scavi & Ray Prosecco DOC, Crème de Cassis
        notes:
  ...
  - id: trade-routes
    label:
      ...
      en: The Trade Routes
    note:
      da: Et udvalg af livlige sour-cocktails inspireret af verdens handelsruter, sæsonens råvarer og dristige citrusdrevne kompositioner. Hver drink er en rejse i smag, hvor syre, sødme og struktur balanceres.
      en: A selection of vibrant sour-style cocktails inspired by global trade routes, seasonal ingredients and bold citrus-driven compositions. Each drink reflects a journey of flavour, balancing acidity, sweetness and structure.
    cocktails:
      - name: Terra Roja
        ingredients:
          da: Ilegal Joven Mezcal, lime, agavesirup, sriracha, koriander-grapefrugtsoda
          en: Ilegal Joven Mezcal, lime, agave syrup, sriracha, coriander grapefruit soda
        notes:
          da: røget agave / citrusskarphed / mild styrke / forfriskende afslutning
          en: smoky agave / citrus sharpness / subtle heat / refreshing finish
      - name: Silk Road Sour
        ingredients:
          da: Barsol Quebranta Pisco, abrikosbrandy, vanilje, abrikosmarmelade, lime, æggehvide
          en: Barsol Quebranta Pisco, Apricot Brandy, vanilla, apricot marmalade, lime, egg white
        notes:
